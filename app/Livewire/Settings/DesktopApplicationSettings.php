...
class DesktopApplicationSettings extends Component
{
    ...
    public $mac_intel_file_path = '';
    public $linux_file_path = '';
    public $mac_silicon_file_path = '';
    public $desktopApp;

    protected $rules = [
        'windows_file_path' => 'nullable|string|url',
        'mac_intel_file_path' => 'nullable|string|url',
        'linux_file_path' => 'nullable|string|url',
        'mac_silicon_file_path' => 'nullable|string|url',
    ];
    ...
    public function loadExistingData()
    {
        ...
        if ($this->desktopApp) {
            $this->windows_file_path = $this->desktopApp->windows_file_path ?? '';
            $this->mac_intel_file_path = $this->desktopApp->mac_intel_file_path ?? '';
            $this->linux_file_path = $this->desktopApp->linux_file_path ?? '';
            $this->mac_silicon_file_path = $this->desktopApp->mac_silicon_file_path ?? '';
        }
    }
    ...
    public function saveAll()
    {
        ...
        $desktopApp->mac_intel_file_path = $this->mac_intel_file_path;
        $desktopApp->mac_silicon_file_path = $this->mac_silicon_file_path;
    ...
    public function resetMacIntelUrl()
    {
        $this->mac_intel_file_path = DesktopApplication::MAC_INTEL_FILE_PATH;
    }

    public function resetMacSiliconUrl()
    {
        $this->mac_silicon_file_path = DesktopApplication::MAC_SILICON_FILE_PATH;
    }
