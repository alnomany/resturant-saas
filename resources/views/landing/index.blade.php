          ...
          <div class="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div class="flex gap-4">
                ...
                <div class="grow">
                  ...
                  <p>
                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-skin-base hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:@lang('landing.contactEmail')">
...
<!-- End Contact -->
<!-- who is used our programmer -->
  <div class="wrap">
    <header style="text-align: center">
      <div class="" style="">
        <h1 class="" style="text-align: center;font-wight:bold;border:2px solid rgb(167 139 250);">من يستخدموا برنامجنا</h1>
        <div>
        </div>
      </div>

      <div class="inline" aria-hidden>
        <span class="category-tag">نفاط بيع / ادارة حجوزات / موقع خاص</span>
      </div>
    </header>

    <!-- Controls (pure HTML/CSS ready; no JS) -->
    ...
    <main class="grid" role="list">
      ...
      <article class="card" role="listitem">
        <h3>شاورما</h3>
        <p>مطعم شاورما سريع مناسب لنظام توصيل وحضور.</p>
      </article>

      <article class="card" role="listitem">
        <h3>برجر</h3>
        <p>مطاعم برجر (سندوتشات) مع قوائم إضافات وتخصيص.</p>
      </article>

      <article class="card" role="listitem">
        <h3>بيتزا</h3>
        <p>مخابز/مطاعم بيتزا مع خيارات حجم وعجائن متعددة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>بروستد / دجاج مقلي</h3>
        <p>قوائم وجبات، علب، وأصناف للتوصيل.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات بحرية</h3>
        <p>قوائم أطباق بحرية، تتطلب مخازن تبريد خاصّة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مشاوي وكباب</h3>
        <p>مطاعم مشاوي مع خيارات حسب الوزن والطبق.</p>
      </article>

      <article class="card" role="listitem">
        <h3>فطور</h3>
        <p>مطاعم إفطار وصتحية صباحية مع قوائم وجبات متكررة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات سريعة (Fast Food)</h3>
        <p>سلاسل سريعة، قوائم مبسطة وطلبات سريعة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات هندية/آسيوية</h3>
        <p>مأكولات حسب توابل ومكونات خاصة وقوائم متعددة الأطباق.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات شامية/عربية</h3>
        <p>مطاعم تقدم الأطباق التقليدية مثل المشاوي والسلطات.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات تركية</h3>
        <p>مطاعم تركية متخصصة في الكباب والميزات المحلية.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مأكولات صحية/دايت</h3>
        <p>قوائم منخفضة السعرات مع معلومات تغذية.</p>
      </article>

      <article class="card" role="listitem">
        <h3>فاين داينينغ (راقي)</h3>
        <p>مطاعم راقية مع قوائم موسمية وحجوزات مسبقة.</p>
      </article>

      <!-- Cafes -->
      <article class="card" role="listitem">
        <h3>كوفي شوب مختص (Specialty Coffee)</h3>
        <p>قوائم بن خاصة، أدوات تحضير ومتاجر ذات هوية بصرية قوية.</p>
      </article>

      <article class="card" role="listitem">
        <h3>كوفي شوب تجاري</h3>
        <p>مقاهي تقدم قائمة قهوة قياسية وحلويات.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مقهى شعبي</h3>
        <p>شاي وقهوة شعبية مع خدمات بسيطة وسعر منخفض.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مقهى حلويات + قهوة</h3>
        <p>مشروع يجمع بين الكافيه والحلويات المعلّبة أو الطازجة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>عصائر وسموذي</h3>
        <p>محلات متخصصة في العصائر الطازجة والسموذي الصحية.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مقهى إنترنت/ألعاب</h3>
        <p>خدمات إنترنت، ألعاب، وغرف جلسات متكاملة.</p>
      </article>

      <!-- Bakeries -->
      <article class="card" role="listitem">
        <h3>مخبز آلي</h3>
        <p>إنتاج خبز يومي بكميات كبيرة لبيع التجزئة أو الجملة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مخبز معجنات</h3>
        <p>كرواسون، فطائر، وخيارات فطور جاهزة.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مخبز حلويات</h3>
        <p>تورتات، كيك وحلويات حسب الطلب.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مخبز بيتزا/معجنات إيطالية</h3>
        <p>خبز ومعجنات إيطالية جاهزة أو حسب الطلب.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مخبز تقليدي (تنور)</h3>
        <p>خبز تقليدي مصنوع على النار أو التنور.
        </p>
      </article>

      <!-- Other types -->
      <article class="card" role="listitem">
        <h3>مطعم توصيل فقط (Cloud Kitchen)</h3>
        <p>مطبخ يعمل للتوصيل عبر التطبيقات بدون قاعة طعام.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مطعم نباتي/نباتي صرف</h3>
        <p>قوائم نباتية بالكامل ومكونات بديلة للحوم.</p>
      </article>

      <article class="card" role="listitem">
        <h3>مطعم بوفيه / مناسبات</h3>
        <p>خدمات بوفيه لحفلات ومناسبات ومجموعات كبيرة.</p>
      </article>
...
<a href="https://wa.me/1234567890" target="_blank">
  <i class="fab fa-whatsapp" style="font-size:40px; color:green;"></i>
</a>
<script>
...
"position": "right",
"textColor": "#ffffff",
"phoneNumber": "+966541749461",
"messageText": "مرحبًا! 🙌 تواصل معي بكتابة رسالة هنا. ستصل مباشرة إلى هاتفي! 🔥",
"trackClick": true
}
}
s.onload = function() {
