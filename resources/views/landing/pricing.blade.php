            ...
            @php
                $packageAllModules = array_merge(
                    ...
                    $package->additional_features ? json_decode($package->additional_features, true) : []
                        ...
                        $packageAllModules = array_map(function($module){
                                return __('modules1.' . $module); // هنا نفترض أن اسم الوحدة موجود في resources/lang/ar/modules.php
                            }, $packageAllModules);
            @endphp
            <div class="bg-white border border-gray-200 rounded-xl p-6 dark:bg-neutral-900 dark:border-neutral-800">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-800 dark:text-neutral-200">{{ __($moduleName) }}</span>
