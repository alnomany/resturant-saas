                ...
                <div class="items-center justify-between gap-3 mt-4 space-y-1 lg:flex">
                    <div class="inline-flex gap-4">
                        ...
                        <div>
                            ...
                            @endif
                        @endif                                    
                                    <div class="flex flex-col md:flex-row gap-6 justify-center p-6">

                                      <div class="max-w-sm w-full mx-auto bg-white dark:bg-gray-800 rounded-[2rem] shadow-2xl shadow-blue-100 dark:shadow-none border border-blue-50 overflow-hidden transition-all duration-300 hover:shadow-blue-200">
    
                                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 p-8 flex flex-col items-center">
                                        <div class="bg-blue-600 text-white rounded-2xl p-4 shadow-lg shadow-blue-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2v2m0 16v2m10-10h-2M4 12H2m15.364-6.364l-1.414 1.414M6.05 17.95l-1.414 1.414M17.95 17.95l-1.414-1.414M6.05 6.05L4.636 7.464" />
                                            </svg>
                                        </div>
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl text-center">
                                                <span class="block text-xs text-gray-500 dark:text-gray-400 mb-1 font-medium">قيمة الخصم</span>
                                                <span class="text-lg font-bold text-green-600 tracking-tight"> {{-- $order->customer->loyalty_points * config('loyalty.point_value') --}} <small class="text-xs">ريال</small></span>
                                            </div>
                                            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl text-center border border-blue-100 dark:border-gray-600">
                                                <span class="block text-xs text-gray-500 dark:text-gray-400 mb-1 font-medium">بعد الخصم</span>
                                                <span class="text-lg font-bold text-blue-700 dark:text-blue-300 tracking-tight"> {{ $pointsFinalAmount  }}  <small class="text-xs">ريال</small></span>
                                            </div>
                                        </div>

                                        <div class="space-y-3">
                                       <div class="relative group" wire:key="loyalty-input-{{ $loyaltyPoints }}">
                                            <input 
                                                type="number" 
                                                wire:model="loyaltyPoints"
                                                class="..." >
                                        </div>
                                            
                                            <button 
                                                wire:click="applyPointsToOrder"
                                                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-2xl shadow-xl shadow-blue-100 dark:shadow-none transition-all duration-200 active:scale-[0.98]">
                                                تطبيق الخصم الآن
                                            </button>
                                        ...
                                        <div class="pt-4 border-t border-dashed border-gray-200 dark:border-gray-600">
                                            <div class="flex justify-between items-center mb-2">
                                                <span class="text-gray-500 dark:text-gray-400 font-medium">الخصم المستحق:</span>
                                                <span class="text-gray-800 dark:text-white font-bold text-lg"> {{-- $order->customer->loyalty_points * config('loyalty.point_value') --}}  ريال</span>
                                            </div>
                                            <div class="flex justify-between items-center bg-blue-600 p-4 rounded-2xl text-white shadow-inner">
                                                <span class="font-medium">المبلغ المطلوب سداده:</span>
                                                <span class="text-2xl font-black">{{ $pointsFinalAmount }} ريال</span>
                                            </div>
                                        </div>
                                    </div>
                        </div>
                                            ...
                                            <div class="inline-flex items-center justify-center gap-2">
                                                @if($order->status !== 'pending_verification' && user_can('Update Order'))
                                                    <x-select wire:model.live="item.payment_method"
                                                            ...
                                                            class="w-32 text-sm">
                                                        @foreach(['cash', 'card', 'upi', 'due'] as $method)
