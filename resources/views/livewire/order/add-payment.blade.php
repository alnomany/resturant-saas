        ...
        <x-slot name="title">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                ...
                <div class="flex items-center gap-2 sm:gap-4 mt-2 sm:mt-0">
                    <span class="text-base sm:text-lg font-medium">{{ __('modules.order.orderHash') }}{{ $order->order_number }}</span>
                    <span class="text-lg sm:text-xl font-bold text-skin-base">{{ currency_format($order->total-$points_discount_x) }}</span>
                </div>
            </div>
            @endif
        </x-slot>
            ...
            <div x-data="{
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                <label class="block text-sm mb-1">{{ __('modules.order.amount') }}</label>
                                    <p>قيمة الخصم: {{ number_format($points_discount_x, 2) }} ريال</p>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 my-2 text-sm sm:text-base">
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <!-- ahmed-->
                                        <span class="font-medium">{{ currency_format($order->total-$points_discount_x) }}</span>
                                    </div>
                                    <div class="flex justify-between">
                ...
                <div x-show="showSplitOptions"
                                            ...
                                            <div class="p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                                        ...
                                                        @if($item['discount'] > 0)
                                                            <span>- {{ __('modules.order.discount') }}: {{ currency_format($item['discount']) }}</span>
                                                        @endif
                                                        ...
                                                        @endif
                                                        @if($item['tip'] > 0)
                                                            <span>+ {{ __('modules.order.tipAmount') }}: {{ currency_format($item['tip']) }}</span>
                                                        @endif
                                                        )
                                                    </div>
                                                </div>
                    ...
                    <div class="border-t dark:border-gray-300 bg-white dark:bg-gray-800">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mt-2 text-sm sm:text-base">
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span>{{ __('modules.order.totalBill') }}</span>
