...
@endif
                    ...
                    <div class="font-medium text-gray-600 text-sm dark:text-gray-400">
                        @lang('modules.order.orderNumber') #{{ $order->order_number }} / {{ $order->delivery_address }}
                    </div>
                </div>
            </div>
        ...
        <div class="flex w-full justify-between items-center border-t dark:border-gray-500 pt-3">
            ...
            @if ($order->waiter)
            <div class="inline-flex items-center text-gray-600 text-sm gap-1 ltr:pl-1 rtl:pr-1 dark:text-gray-400">
